...
//list of global files that can be accepted form anywhere in program
FILE *fp,*ft,*fs;

//list of global variable
int s;
char findbook;
char password[10]={"adarivamsi"};
...
void mainmenu()
{
    ...
    case '7':
		...
		printf("Programmer....");
		gotoxy(16,4);
		printf("Adari Vamsi Charan                ");
		gotoxy(16,5);
		printf("   Mobile:8985995829  E-mail:adarivamsi@gmail.com");
		gotoxy(16,7);
		gotoxy(10,17);
